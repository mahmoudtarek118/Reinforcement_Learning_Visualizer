...
const ALGORITHM_ID = 'td-learning';
    ...
    return (
        <div className="algorithm-page">
            <header className="page-header">
                <h1>TD Learning</h1>
                <p>Bootstrap value estimates using temporal difference</p>
            </header>
            <div className="algorithm-description">
                <h2>Algorithm Description</h2>
                <p>TD learning updates values after each step:</p>
                <div className="formula">V(S) ← V(S) + α[R + γV(S') - V(S)]</div>
            </div>
            <div className="page-content">
                <section className="controls-section">
                    ...
                    <div className="control-buttons">
                        {!isRunning ? (
                            <button className="run-button" onClick={handleStart}>▶ Run TD Learning</button>
                        ) : (
