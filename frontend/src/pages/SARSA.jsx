    ...
    return (
        <div className="algorithm-page">
            <header className="page-header">
                <h1>SARSA</h1>
                <p>On-policy TD control with ε-greedy exploration</p>
            </header>
            <div className="algorithm-description">
                <h2>Algorithm Description</h2>
                <p>SARSA learns Q-values on-policy:</p>
                <div className="formula">Q(S,A) ← Q(S,A) + α[R + γQ(S',A') - Q(S,A)]</div>
            </div>
            <div className="page-content">
                <section className="controls-section">
                    ...
                    <div className="control-buttons">
                        {!isRunning ? (
                            <button className="run-button" onClick={handleStart}>▶ Run SARSA</button>
                        ) : (
