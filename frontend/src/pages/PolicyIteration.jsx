...
const ALGORITHM_ID = 'policy-iteration';
    ...
    return (
        <div className="algorithm-page">
            <header className="page-header">
                ...
                <p>Find optimal policy by alternating evaluation and improvement</p>
            </header>
            <div className="algorithm-description">
                <h2>Algorithm Description</h2>
                <p>Alternates between policy evaluation and policy improvement:</p>
                <div className="formula">π(s) = argmax<sub>a</sub> [R(s,a) + γV(s')]</div>
            </div>
                    ...
                    <div className="control-buttons">
                        {!isRunning ? (
                            <button className="run-button" onClick={handleStart} disabled={converged}>
                                {converged ? '✓ Converged' : '▶ Run Policy Iteration'}
                            </button>
                        ) : (
